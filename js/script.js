...
var heartBtn = document.querySelectorAll('[data-heart-btn]');
var countNumber = document.querySelectorAll('[data-count-number]');
...
var bagBtn = document.querySelectorAll('[data-bag-btn]');
var countBagNumber = document.querySelectorAll('[data-bag-number]');
...
bagBtn.forEach((btn) => {
    ...
    btn.addEventListener('click', function(){
        ...
        countBagNumber.forEach((number)=>{
            number.innerHTML = bagCount;
        })
